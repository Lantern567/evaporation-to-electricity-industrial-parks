...
> **最新研究进展，更新于 2026-07-11**
>
> 任务二 **V1 工程估算版** 已完成并补充了工艺流程碳排分析：统一设施输入、
> 气候匹配、类型 I 净蒸发与过程用能核算、类型 II 六候选处置情景、
> 逐站点工艺贡献、逐年碳排比较、质量检查和可视化。
...
| 类型 I 污水处理过程电力碳排 | 809.5 万 tCO2/年 |
| 其中：氧化沟/SBR 过程电力碳排 | 596.2 万 tCO2/年 |
| 其中：常规工艺过程电力碳排 | 210.7 万 tCO2/年 |
...
- [工艺流程碳排分析](docs/task2_process_flow_carbon_analysis_v1.md)
...
- [站点-工艺碳排贡献长表](results/station_process_carbon_2024_base_v1.csv)
- [站点主导工艺与贡献占比](results/station_dominant_process_2024_base_v1.csv)
- [各工艺流程逐年过程碳排](results/process_year_carbon_summary_v1.csv)
- [类型 I/II 碳排逐年比较](results/yearly_carbon_comparison_v1.csv)
- [影子避免碳逐年参考值](results/yearly_shadow_avoided_carbon_reference_v1.csv)

### 代码与图表

- `scripts/`：核算与可视化方法脚本。
- `figures/`：10 张任务二成果图，包括核算总览和新增工艺流程碳排分析。
